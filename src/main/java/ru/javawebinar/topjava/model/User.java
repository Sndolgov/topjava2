...
@Entity
@Table(name = "users", uniqueConstraints = {@UniqueConstraint(columnNames = "email", name = "users_unique_email_idx")}) // нужно тогда, когда hibernate сам генерить БД из entity
